                    ...
                    <div class="card my-4">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mb-2">
                                ...
                                <img src="<?= $base_url; ?>/assets/files/images/<?= $logoMobile; ?>" alt="<?= $judulLogoMobile; ?>" class="img-fluid mt-2">
                            </div>
                            ...
                            <form action="" method="POST" data-parsley-validate="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="username" name="___in_username_special_ARPATEAM" placeholder="Masukkan username anda..." required="">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="password" id="pass" name="___in_password_special_ARPATEAM" placeholder="Masukkan password anda..." required="">
                                </div>
                                ...
                                <div class="mb-3 d-grid text-center">
                                    <button class="btn btn-primary" type="submit" name="_submit_special_ARPATEAM_"> Log In <span class="mdi mdi-login-variant"></span></button>
                                </div>
