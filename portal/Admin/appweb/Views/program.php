<?php
    switch ($_GET['act']) {
        case "edit-program":
            $hal                = "Program";
            $penyimpananGambar  = "$base_url/assets/files/images/program";
            $database           = "program";
            $link               = "program";
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="editProgram/" method="POST" data-parsley-validate="" class="modal-content">
                            ...
                            <div class="modal-body row">
                                ...
                                <div class="col-md-2 my-1">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="no_urut" name="___in_no_urut_special_ARPATEAM" placeholder="Lorem ipsum dolor sit amet" value="<?= $result['no_urut'] ?>" required="">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="___in_id_program_special_ARPATEAM" value="<?= $result['id_program']; ?>">
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-auto my-auto">
                    <button type="button" class="btn btn-primary rounded-pill waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addProgram"><i class="fas fa-plus"></i> Tambah <?= $hal ?></button>

                    <div id="addProgram" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-xl">
                            <form action="addProgram/" method="POST" data-parsley-validate="" class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body row">
                                    ...
                                    <div class="col-md-2 my-1">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" id="no_urut" name="___in_no_urut_special_ARPATEAM" placeholder="Lorem ipsum dolor sit amet" required="">
                                            <label for="no_urut">No Urut</label>
                                        </div>
                                    </div>
                                    <div class="col-md-10 my-1">
                        ...
                        <table id="datatable" class="table table-bordered table-striped dt-responsive table-responsive nowrap">
                            ...
                            <tbody>
                                <?php
                                    $no=1;
                                    $query = $pdo->query("
                                            SELECT id_program, no_urut, judul, slug, tgl_update
                                            FROM $database
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="program/<?= $result['slug'] ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                        <a onclick="confirmHapusProgram('<?= $result['id_program']; ?>')" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
