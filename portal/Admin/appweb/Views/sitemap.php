                ...
                <div class="col-auto my-auto">
                    ...
                    <div id="TambahSitemap" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-lg">
                            <form action="addSitemap/" method="POST" data-parsley-validate="" class="modal-content">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div id="UbahSitemap<?= $resultData['id_sitemap'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-lg">
                                                <form action="editSitemap/" method="POST" data-parsley-validate="" class="modal-content">
                                                    <div class="modal-header">
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="editLayanan/" method="POST" data-parsley-validate="" class="modal-content">
                            <div class="modal-header">
