<?php
    switch ($_GET['act']) {
        case "edit-kabar":
            $hal                = "Kabar";
            $penyimpananGambar  = "$base_url/assets/files/images/kabar";
            $database           = "kabar";
            $link               = "kabar";
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                        <form action="editKabar/" method="POST" data-parsley-validate="" class="modal-content" enctype="multipart/form-data">
                            ...
                            <div class="modal-body row">
                                ...
                                <div class="col-md-4 my-1">
                                    <div class="form-floating">
                                        <select class="form-select" id="slider" name="___in_slider_special_ARPATEAM" required="">
                                            <option value="Yes" <?php if ($result['slider']==="Yes") { echo "selected"; } ?>><i class="fas fa-check"></i> Yes</option>
                                            <option value="No" <?php if ($result['slider']==="No") { echo "selected"; } ?>><i class="fas fa-times"></i> No</option>
                                        </select>
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="___in_id_kabar_special_ARPATEAM" value="<?= $result['id_kabar']; ?>">
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-auto my-auto">
                    <button type="button" class="btn btn-primary rounded-pill waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#addKabar"><i class="fas fa-plus"></i> Tambah <?= $hal ?></button>

                    <div id="addKabar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-xl">
                            <form action="addKabar/" method="POST" data-parsley-validate="" class="modal-content" enctype="multipart/form-data">
                                <div class="modal-header">
                                    ...
                                    <div class="col-md-4 my-1">
                                        <div class="form-floating">
                                            <select class="form-select" id="slider" name="___in_slider_special_ARPATEAM" required="">
                                                ...
                                                <option value="Yes"><i class="fas fa-check"></i> Yes</option>
                                                <option value="No"><i class="fas fa-times"></i> No</option>
                                            </select>
                                            <label for="slider">Slider?</label>
                                        </div>
                                    </div>
                        ...
                        <table id="datatable" class="table table-bordered table-striped dt-responsive table-responsive nowrap">
                            ...
                            <tbody>
                                <?php
                                    $no=1;
                                    $query = $pdo->query("
                                            SELECT id_kabar, slider, judul, slug, tgl_terbit, tgl_update
                                            FROM $database
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="kabar/<?= $result['slug'] ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                        <a onclick="confirmHapusKabar('<?= $result['id_kabar']; ?>')" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
